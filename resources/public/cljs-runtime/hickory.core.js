...
var G__39018_39174 = hickory.core.as_hiccup;
var G__39019_39175 = "object";
var G__39020_39176 = (function (this$){
var pred__39021 = cljs.core._EQ_;
var expr__39022 = (this$["nodeType"]);
if(cljs.core.truth_((pred__39021.cljs$core$IFn$_invoke$arity$2 ? pred__39021.cljs$core$IFn$_invoke$arity$2(hickory.core.Attribute,expr__39022) : pred__39021.call(null,hickory.core.Attribute,expr__39022)))){
...
if(cljs.core.truth_((pred__39021.cljs$core$IFn$_invoke$arity$2 ? pred__39021.cljs$core$IFn$_invoke$arity$2(hickory.core.Comment,expr__39022) : pred__39021.call(null,hickory.core.Comment,expr__39022)))){
return ["<!--",cljs.core.str.cljs$core$IFn$_invoke$arity$1((this$["data"])),"-->"].join('');
} else {
if(cljs.core.truth_((pred__39021.cljs$core$IFn$_invoke$arity$2 ? pred__39021.cljs$core$IFn$_invoke$arity$2(hickory.core.Document,expr__39022) : pred__39021.call(null,hickory.core.Document,expr__39022)))){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(hickory.core.as_hiccup,(this$["childNodes"]));
} else {
if(cljs.core.truth_((pred__39021.cljs$core$IFn$_invoke$arity$2 ? pred__39021.cljs$core$IFn$_invoke$arity$2(hickory.core.DocumentType,expr__39022) : pred__39021.call(null,hickory.core.DocumentType,expr__39022)))){
return hickory.core.format_doctype(this$);
} else {
if(cljs.core.truth_((pred__39021.cljs$core$IFn$_invoke$arity$2 ? pred__39021.cljs$core$IFn$_invoke$arity$2(hickory.core.Element,expr__39022) : pred__39021.call(null,hickory.core.Element,expr__39022)))){
var tag = hickory.utils.lower_case_keyword((this$["tagName"]));
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(hickory.core.as_hiccup,(this$["attributes"])))], null),(cljs.core.truth_((hickory.utils.unescapable_content.cljs$core$IFn$_invoke$arity$1 ? hickory.utils.unescapable_content.cljs$core$IFn$_invoke$arity$1(tag) : hickory.utils.unescapable_content.call(null,tag)))?cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39017_SHARP_){
return (p1__39017_SHARP_["wholeText"]);
}),(this$["childNodes"])):cljs.core.map.cljs$core$IFn$_invoke$arity$2(hickory.core.as_hiccup,(this$["childNodes"])))));
} else {
if(cljs.core.truth_((pred__39021.cljs$core$IFn$_invoke$arity$2 ? pred__39021.cljs$core$IFn$_invoke$arity$2(hickory.core.Text,expr__39022) : pred__39021.call(null,hickory.core.Text,expr__39022)))){
return hickory.utils.html_escape((this$["wholeText"]));
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__39022)].join('')));
}
}
}
}
...
goog.object.set(G__39018_39174,G__39019_39175,G__39020_39176);
goog.object.set(hickory.core.HickoryRepresentable,"object",true);

var G__39050_39194 = hickory.core.as_hickory;
var G__39051_39195 = "object";
var G__39052_39196 = (function (this$){
var pred__39055 = cljs.core._EQ_;
var expr__39056 = (this$["nodeType"]);
if(cljs.core.truth_((pred__39055.cljs$core$IFn$_invoke$arity$2 ? pred__39055.cljs$core$IFn$_invoke$arity$2(hickory.core.Attribute,expr__39056) : pred__39055.call(null,hickory.core.Attribute,expr__39056)))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hickory.utils.lower_case_keyword((this$["name"])),(this$["value"])], null);
} else {
if(cljs.core.truth_((pred__39055.cljs$core$IFn$_invoke$arity$2 ? pred__39055.cljs$core$IFn$_invoke$arity$2(hickory.core.Comment,expr__39056) : pred__39055.call(null,hickory.core.Comment,expr__39056)))){
...
if(cljs.core.truth_((pred__39055.cljs$core$IFn$_invoke$arity$2 ? pred__39055.cljs$core$IFn$_invoke$arity$2(hickory.core.Document,expr__39056) : pred__39055.call(null,hickory.core.Document,expr__39056)))){
...
if(cljs.core.truth_((pred__39055.cljs$core$IFn$_invoke$arity$2 ? pred__39055.cljs$core$IFn$_invoke$arity$2(hickory.core.DocumentType,expr__39056) : pred__39055.call(null,hickory.core.DocumentType,expr__39056)))){
...
if(cljs.core.truth_((pred__39055.cljs$core$IFn$_invoke$arity$2 ? pred__39055.cljs$core$IFn$_invoke$arity$2(hickory.core.Element,expr__39056) : pred__39055.call(null,hickory.core.Element,expr__39056)))){
...
if(cljs.core.truth_((pred__39055.cljs$core$IFn$_invoke$arity$2 ? pred__39055.cljs$core$IFn$_invoke$arity$2(hickory.core.Text,expr__39056) : pred__39055.call(null,hickory.core.Text,expr__39056)))){
return (this$["wholeText"]);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__39056)].join('')));
}
}
}
}
...
goog.object.set(G__39050_39194,G__39051_39195,G__39052_39196);
...
var temp__5735__auto___39237 = cljs.core.first((doc["head"]["childNodes"]));
if(cljs.core.truth_(temp__5735__auto___39237)){
var title_el_39240 = temp__5735__auto___39237;
if(cljs.core.empty_QMARK_((title_el_39240["text"]))){
hickory.core.remove_el(title_el_39240);
} else {
}
} else {
}
