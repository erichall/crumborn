...
if((i < len)){
var k = (ks[i]);
var G__29087 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__29088 = (i + (1));
m = G__29087;
i = G__29088;
continue;
...
var temp__5737__auto__ = p.argv;
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__28977 = p.children;
return module$node_modules$react$index.Children.toArray(G__28977);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__28979 = c;
var G__28979__$1 = (((G__28979 == null))?null:G__28979.prototype);
if((G__28979__$1 == null)){
return null;
} else {
return G__28979__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__28983 = c;
var G__28983__$1 = (((G__28983 == null))?null:G__28983.prototype);
if((G__28983__$1 == null)){
return null;
} else {
return G__28983__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__29090__delegate = function (args){
var G__28991 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__28991) : reagent.impl.component.as_element.call(null,G__28991));
};
var G__29090 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__29091__i = 0, G__29091__a = new Array(arguments.length -  0);
while (G__29091__i < G__29091__a.length) {G__29091__a[G__29091__i] = arguments[G__29091__i + 0]; ++G__29091__i;}
  args = new cljs.core.IndexedSeq(G__29091__a,0,null);
} 
return G__29090__delegate.call(this,args);};
G__29090.cljs$lang$maxFixedArity = 0;
G__29090.cljs$lang$applyTo = (function (arglist__29092){
var args = cljs.core.seq(arglist__29092);
return G__29090__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__28992 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__28993 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__28993);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__28992);
}});
...
var G__28994 = key;
var G__28994__$1 = (((G__28994 instanceof cljs.core.Keyword))?G__28994.fqn:null);
switch (G__28994__$1) {
...
var c = this;
var G__29007_29098 = goog.object.get(c,"cljsRatom");
if((G__29007_29098 == null)){
} else {
reagent.ratom.dispose_BANG_(G__29007_29098);
}
...
var renders_29103 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_29104 = cljs.core.first(cljs.core.vals(renders_29103));
...
if((cljs.core.count(renders_29103) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_29103))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_29104)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_29104], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__29052 = o;
var G__29054_29112 = G__29052;
var G__29055_29113 = cljs.core.name(k);
var G__29056_29114 = v;
goog.object.set(G__29054_29112,G__29055_29113,G__29056_29114);
...
var G__29058_29117 = cmp.prototype;
var G__29059_29118 = module$node_modules$react$index.Component.prototype;
var G__29060_29119 = methods$;
goog.object.extend(G__29058_29117,G__29059_29118,G__29060_29119);
...
var name = (function (){var G__29065 = fiber;
var G__29065__$1 = (((G__29065 == null))?null:G__29065.type);
if((G__29065__$1 == null)){
return null;
} else {
return G__29065__$1.displayName;
}
})();
var parent = (function (){var G__29066 = fiber;
if((G__29066 == null)){
return null;
} else {
return G__29066.return;
}
})();
var path = (function (){var G__29067 = parent;
var G__29067__$1 = (((G__29067 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__29067) : reagent.impl.component.fiber_component_path.call(null,G__29067)));
if((G__29067__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29067__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__29072 = c;
if((G__29072 == null)){
return null;
} else {
return goog.object.get(G__29072,"_reactInternalFiber");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__29073._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__29075 = c;
if((G__29075 == null)){
return null;
} else {
return goog.object.get(G__29075,"_reactInternalInstance");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__29077 = c;
if((G__29077 == null)){
return null;
} else {
return G__29077._reactInternalInstance;
}
})();
if(cljs.core.truth_(or__4185__auto____$1)){
return or__4185__auto____$1;
...
var elem = (function (){var or__4185__auto__ = (function (){var G__29079 = instance;
if((G__29079 == null)){
return null;
} else {
return goog.object.get(G__29079,"_currentElement");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__29080 = instance;
if((G__29080 == null)){
return null;
} else {
return G__29080._currentElement;
}
}
})();
var name = (function (){var G__29081 = elem;
var G__29081__$1 = (((G__29081 == null))?null:G__29081.type);
if((G__29081__$1 == null)){
return null;
} else {
return G__29081__$1.displayName;
}
})();
var owner = (function (){var or__4185__auto__ = (function (){var G__29083 = elem;
if((G__29083 == null)){
return null;
} else {
return goog.object.get(G__29083,"_owner");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__29084._owner;
}
}
})();
var path = (function (){var G__29085 = owner;
var G__29085__$1 = (((G__29085 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__29085) : reagent.impl.component.component_path.call(null,G__29085)));
if((G__29085__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29085__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__29086 = c;
var G__29086__$1 = (((G__29086 == null))?null:G__29086.constructor);
if((G__29086__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__29086__$1);
}
}
})();
