...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39341_SHARP_){
return cljs.core.identity(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"text","text",-1790561697),p1__39341_SHARP_], null));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.string.trim,(function (){var G__39344 = clojure.string.trim((function (){var fexpr__39346 = (function (p1__39339_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(p1__39339_SHARP_),"|")){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.rest(p1__39339_SHARP_));
} else {
return p1__39339_SHARP_;
}
});
return fexpr__39346(text);
})());
var fexpr__39343 = (function (p1__39340_SHARP_){
return clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__39340_SHARP_,/\|/);
});
return fexpr__39343(G__39344);
})()));
});
...
var is_table_divider_QMARK_ = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(table_divider_re,text))?(function (){var and__4174__auto__ = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"table","table",-564943036),new cljs.core.Keyword(null,"in-table-body?","in-table-body?",-136773915)], null));
