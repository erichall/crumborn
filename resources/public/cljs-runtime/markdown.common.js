...
while(true){
if((i__4790__auto___38986 < len__4789__auto___38984)){
...
/** @this {Function} */
(markdown.common.freeze_string.cljs$lang$applyTo = (function (seq38849){
...
var G__38999 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (text,state,matches,temp__5733__auto__){
return (function (s,r){
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560).cljs$core$IFn$_invoke$arity$1(state),p1__38867_SHARP_,p1__38867_SHARP_);
});})(text,state,matches,temp__5733__auto__))
);
});})(text,state,matches,temp__5733__auto__))
,text,matches);
var G__39000 = cljs.core.update.cljs$core$IFn$_invoke$arity$3(state,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560),((function (text,state,matches,temp__5733__auto__){
return (function (p1__38868_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc,p1__38868_SHARP_,matches);
});})(text,state,matches,temp__5733__auto__))
);
text = G__38999;
state = G__39000;
...
var vec__38912 = (((transformer === cljs.core.identity))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [buf,cur_state], null):(function (){var vec__38916 = (function (){var G__38919 = clojure.string.join.cljs$core$IFn$_invoke$arity$1(buf);
var G__38920 = cur_state;
return (transformer.cljs$core$IFn$_invoke$arity$2 ? transformer.cljs$core$IFn$_invoke$arity$2(G__38919,G__38920) : transformer.call(null,G__38919,G__38920));
})();
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38916,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38916,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.seq(s),new_state], null);
})());
var new_buf = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38912,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38912,(1),null);
var G__39091 = cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(out,cljs.core.seq(open),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new_buf,cljs.core.seq(close)], 0)));
var G__39092 = cljs.core.PersistentVector.EMPTY;
var G__39093 = cljs.core.rest(tokens);
var G__39094 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(new_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),false);
out = G__39091;
buf = G__39092;
tokens = G__39093;
cur_state = G__39094;
...
var G__39105 = out;
var G__39106 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.first(tokens));
var G__39107 = cljs.core.rest(tokens);
var G__39108 = cur_state;
out = G__39105;
buf = G__39106;
tokens = G__39107;
cur_state = G__39108;
...
var G__39119 = out;
var G__39120 = buf;
var G__39121 = cljs.core.rest(tokens);
var G__39122 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cur_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),true);
out = G__39119;
buf = G__39120;
tokens = G__39121;
cur_state = G__39122;
...
var G__39128 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(out,cljs.core.first(tokens));
var G__39129 = buf;
var G__39130 = cljs.core.rest(tokens);
var G__39131 = cur_state;
out = G__39128;
buf = G__39129;
tokens = G__39130;
cur_state = G__39131;
...
var fexpr__38936 = markdown.common.make_separator.cljs$core$IFn$_invoke$arity$4(separator,open,close,(cljs.core.truth_(escape_QMARK_)?markdown.common.escape_code_transformer:cljs.core.identity));
return (fexpr__38936.cljs$core$IFn$_invoke$arity$2 ? fexpr__38936.cljs$core$IFn$_invoke$arity$2(text,state) : fexpr__38936.call(null,text,state));
});
...
var fexpr__38945 = markdown.common.make_separator.cljs$core$IFn$_invoke$arity$4(markdown.common._STAR_inhibit_separator_STAR_,"","",markdown.common.freeze_string);
return (fexpr__38945.cljs$core$IFn$_invoke$arity$2 ? fexpr__38945.cljs$core$IFn$_invoke$arity$2(text,state) : fexpr__38945.call(null,text,state));
} else {
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [text,state], null);
}
});
...
var num_hashes = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__38952_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__38952_SHARP_);
}),cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__38953_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",p1__38953_SHARP_)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__38953_SHARP_)));
}),cljs.core.seq(text))));
if((num_hashes > (0))){
return num_hashes;
} else {
