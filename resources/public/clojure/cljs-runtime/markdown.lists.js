...
return clojure.string.join.cljs$core$IFn$_invoke$arity$1((function (){var iter__4582__auto__ = (function markdown$lists$close_lists_$_iter__39169(s__39170){
return (new cljs.core.LazySeq(null,(function (){
var s__39170__$1 = s__39170;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__39170__$1);
if(temp__5735__auto__){
var s__39170__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__39170__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__39170__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__39172 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__39171 = (0);
while(true){
if((i__39171 < size__4581__auto__)){
var vec__39177 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__39171);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39177,(0),null);
cljs.core.chunk_append(b__39172,["</li></",cljs.core.name(list_type),">"].join(''));

var G__39252 = (i__39171 + (1));
i__39171 = G__39252;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__39172),markdown$lists$close_lists_$_iter__39169(cljs.core.chunk_rest(s__39170__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__39172),null);
}
} else {
var vec__39180 = cljs.core.first(s__39170__$2);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39180,(0),null);
return cljs.core.cons(["</li></",cljs.core.name(list_type),">"].join(''),markdown$lists$close_lists_$_iter__39169(cljs.core.rest(s__39170__$2)));
}
} else {
return null;
}
...
var lists_to_close = cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__39183_SHARP_){
return (cljs.core.second(p1__39183_SHARP_) > num_indents);
...
var vec__39202 = cljs.core.last(new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39202,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39202,(1),null);
...
var content = clojure.string.trim((function (){var G__39205 = text;
var G__39206 = (num_indents + (1));
return (markdown.common._STAR_substring_STAR_.cljs$core$IFn$_invoke$arity$2 ? markdown.common._STAR_substring_STAR_.cljs$core$IFn$_invoke$arity$2(G__39205,G__39206) : markdown.common._STAR_substring_STAR_.call(null,G__39205,G__39206));
})());
...
var vec__39215 = cljs.core.last(new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39215,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39215,(1),null);
var num_indents = cljs.core.count(cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core._EQ_," "),text));
...
markdown.lists.li = (function markdown$lists$li(text,p__39227){
...
var state = map__39228__$1;
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39228__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var last_line_empty_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39228__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39228__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39228__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
