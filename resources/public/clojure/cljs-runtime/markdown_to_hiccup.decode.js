...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38721_SHARP_){
return (markdown_to_hiccup.decode.decode.cljs$core$IFn$_invoke$arity$2 ? markdown_to_hiccup.decode.decode.cljs$core$IFn$_invoke$arity$2(p1__38721_SHARP_,transform_str_fn) : markdown_to_hiccup.decode.decode.call(null,p1__38721_SHARP_,transform_str_fn));
}),cljs.core.seq(iseq));
}));
...
var len__4789__auto___38765 = arguments.length;
var i__4790__auto___38766 = (0);
while(true){
if((i__4790__auto___38766 < len__4789__auto___38765)){
args__4795__auto__.push((arguments[i__4790__auto___38766]));

var G__38767 = (i__4790__auto___38766 + (1));
i__4790__auto___38766 = G__38767;
continue;
} else {
}
break;
...
/** @this {Function} */
(markdown_to_hiccup.decode.dispatch.cljs$lang$applyTo = (function (seq38728){
var G__38729 = cljs.core.first(seq38728);
var seq38728__$1 = cljs.core.next(seq38728);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38729,seq38728__$1);
}));
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__38741 = cljs.core.get_global_hierarchy;
...
var G__38774 = null;
var G__38774__1 = (function (s){
return markdown_to_hiccup.decode.decode_string.cljs$core$IFn$_invoke$arity$1(s);
});
var G__38774__2 = (function (s,transform){
return markdown_to_hiccup.decode.decode_string.cljs$core$IFn$_invoke$arity$2(s,transform);
});
G__38774 = function(s,transform){
switch(arguments.length){
case 1:
return G__38774__1.call(this,s);
case 2:
return G__38774__2.call(this,s,transform);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__38774.cljs$core$IFn$_invoke$arity$1 = G__38774__1;
G__38774.cljs$core$IFn$_invoke$arity$2 = G__38774__2;
return G__38774;
})()
);
...
var G__38776__2 = (function (m,transform){
...
G__38776 = function(m,transform){
switch(arguments.length){
case 1:
return G__38776__1.call(this,m);
case 2:
return G__38776__2.call(this,m,transform);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__38776.cljs$core$IFn$_invoke$arity$1 = G__38776__1;
G__38776.cljs$core$IFn$_invoke$arity$2 = G__38776__2;
return G__38776;
})()
);
...
var G__38777 = null;
var G__38777__1 = (function (v){
return cljs.core.vec(markdown_to_hiccup.decode.decode_iseq.cljs$core$IFn$_invoke$arity$1(v));
});
var G__38777__2 = (function (v,transform){
return cljs.core.vec(markdown_to_hiccup.decode.decode_iseq.cljs$core$IFn$_invoke$arity$2(v,transform));
});
G__38777 = function(v,transform){
switch(arguments.length){
case 1:
return G__38777__1.call(this,v);
case 2:
return G__38777__2.call(this,v,transform);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__38777.cljs$core$IFn$_invoke$arity$1 = G__38777__1;
G__38777.cljs$core$IFn$_invoke$arity$2 = G__38777__2;
return G__38777;
})()
);
...
var G__38778__2 = (function (x,f){
return cljs.core.identity(x);
});
G__38778 = function(x,f){
switch(arguments.length){
case 1:
return G__38778__1.call(this,x);
case 2:
return G__38778__2.call(this,x,f);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
